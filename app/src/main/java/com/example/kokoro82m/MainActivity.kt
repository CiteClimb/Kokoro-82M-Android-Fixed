...
private fun generateAudio(
    ...
    scope.launch(Dispatchers.IO) {
        try {
            ...
            // The following line causes this error: "Trying to score a closed OrtSession." when creating audio for the second time after the app is opened.
            // session.close()
        } catch (e: Exception) {
...
sealed class Screen(val title: String) {
    object Basic : Screen("Single-style TTS")
    object Mixer : Screen("Multi-style mixed TTS")
        ...
        bottomBar = {
            NavigationBar {
                NavigationBarItem(
                    icon = {
                        Icon(
                            painter = painterResource(id = R.drawable.ic_voice_selection),
                            contentDescription = "Single-model"
                        )
                    },
                ...
                NavigationBarItem(
                    icon = {
                        Icon(
                            ...
                            contentDescription = "Multi-model"
                        )
                    },
                    label = { Text("Multi-model") },
...
fun BasicScreen(
    ...
    var text by remember { mutableStateOf("I lost the game.") }
    var style by remember { mutableStateOf("bm_george") }
    ...
    Column(
        ...
        Row(
            ...
            Button(
                ...
                Text(if (isProcessing) "GPU Processing..." else "Play & Save as .wav")
            }
        }
    }
}
